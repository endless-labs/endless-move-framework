...
-  [Function `new_less`](#0x1_cmp_new_less)
-  [Function `new_equal`](#0x1_cmp_new_equal)
-  [Function `new_greater`](#0x1_cmp_new_greater)
...
-  [Specification](#@Specification_1)
    -  [Struct `Ordering`](#@Specification_1_Ordering)
    -  [Function `compare`](#@Specification_1_compare)
    -  [Function `is_eq`](#@Specification_1_is_eq)
    -  [Function `is_ne`](#@Specification_1_is_ne)
    -  [Function `is_lt`](#@Specification_1_is_lt)
    -  [Function `is_le`](#@Specification_1_is_le)
    -  [Function `is_gt`](#@Specification_1_is_gt)
    -  [Function `is_ge`](#@Specification_1_is_ge)
...
<a id="0x1_cmp_GREATER"></a>



<pre><code><b>const</b> <a href="cmp.md#0x1_cmp_GREATER">GREATER</a>: u8 = 2;
</code></pre>
...
<pre><code><b>const</b> <a href="cmp.md#0x1_cmp_LESS">LESS</a>: u8 = 0;
</code></pre>



<a id="0x1_cmp_new_less"></a>

## Function `new_less`



<pre><code><b>fun</b> <a href="cmp.md#0x1_cmp_new_less">new_less</a>(): <a href="cmp.md#0x1_cmp_Ordering">cmp::Ordering</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="cmp.md#0x1_cmp_new_less">new_less</a>(): <a href="cmp.md#0x1_cmp_Ordering">Ordering</a> {
    <a href="cmp.md#0x1_cmp_Ordering">Ordering</a> { tag: <a href="cmp.md#0x1_cmp_LESS">LESS</a> }
}
</code></pre>
...
<a id="0x1_cmp_new_equal"></a>

## Function `new_equal`



<pre><code><b>fun</b> <a href="cmp.md#0x1_cmp_new_equal">new_equal</a>(): <a href="cmp.md#0x1_cmp_Ordering">cmp::Ordering</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="cmp.md#0x1_cmp_new_equal">new_equal</a>(): <a href="cmp.md#0x1_cmp_Ordering">Ordering</a> {
    <a href="cmp.md#0x1_cmp_Ordering">Ordering</a> { tag: <a href="cmp.md#0x1_cmp_EQUAL">EQUAL</a> }
}
</code></pre>
...
<a id="0x1_cmp_new_greater"></a>

## Function `new_greater`



<pre><code><b>fun</b> <a href="cmp.md#0x1_cmp_new_greater">new_greater</a>(): <a href="cmp.md#0x1_cmp_Ordering">cmp::Ordering</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="cmp.md#0x1_cmp_new_greater">new_greater</a>(): <a href="cmp.md#0x1_cmp_Ordering">Ordering</a> {
    <a href="cmp.md#0x1_cmp_Ordering">Ordering</a> { tag: <a href="cmp.md#0x1_cmp_GREATER">GREATER</a> }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="cmp.md#0x1_cmp_is_eq">is_eq</a>(self: &<a href="cmp.md#0x1_cmp_Ordering">Ordering</a>): bool {
    self.tag == <a href="cmp.md#0x1_cmp_EQUAL">EQUAL</a>
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="cmp.md#0x1_cmp_is_lt">is_lt</a>(self: &<a href="cmp.md#0x1_cmp_Ordering">Ordering</a>): bool {
    self.tag == <a href="cmp.md#0x1_cmp_LESS">LESS</a>
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="cmp.md#0x1_cmp_is_le">is_le</a>(self: &<a href="cmp.md#0x1_cmp_Ordering">Ordering</a>): bool {
    self.tag != <a href="cmp.md#0x1_cmp_GREATER">GREATER</a>
}
</code></pre>
...
<a id="@Specification_1_Ordering"></a>
