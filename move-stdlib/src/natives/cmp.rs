...
const ORDERING_LESS_THAN_VARIANT: u8 = 0;
const ORDERING_EQUAL_VARIANT: u8 = 1;
const ORDERING_GREATER_THAN_VARIANT: u8 = 2;
...
fn native_compare(
    ...
    Ok(smallvec![Value::struct_(Struct::pack(vec![Value::u8(
