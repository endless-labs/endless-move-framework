...
module example_addr::managed_fungible_token {
    ...
    use std::option;
    use endless_token::token::{create_named_token, create_token_seed};
    use endless_token::collection::create_fixed_collection;
    ...
    fun init_module(admin: &signer) {
        ...
        create_fixed_collection(
            ...
            collection_name,
            option::none(),
            utf8(b"http://endlesslabs.com/collection"),
        );
        let constructor_ref = &create_named_token(admin,
            ...
            token_name,
            option::none(),
            utf8(b"http://endlesslabs.com/token"),
        );
