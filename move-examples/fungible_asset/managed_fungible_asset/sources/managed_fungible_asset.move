...
module example_addr::managed_fungible_asset {
    use endless_framework::fungible_asset::{Self, MintRef, TransferRef, BurnRef, Metadata, FungibleStore, FungibleAsset};
    use endless_framework::object::{Self, Object, ConstructorRef};
    ...
    #[test_only]
    use endless_framework::object::object_from_constructor_ref;
    #[test_only]
    use std::string::utf8;
    use std::vector;
    ...
    fun create_test_mfa(creator: &signer): Object<Metadata> {
        let constructor_ref = &object::create_named_object(creator, b"EDS");
        initialize(
            constructor_ref,
            0,
            utf8(b"Endless Token"), /* name */
            utf8(b"EDS"), /* symbol */
            8, /* decimals */
