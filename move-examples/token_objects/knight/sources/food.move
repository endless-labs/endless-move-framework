...
module knight::food {
    ...
    fun init_module(sender: &signer) {
        ...
        create_food_token_as_fungible_token(
            ...
            string::utf8(b"https://raw.githubusercontent.com/endless-labs/endless-core/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Corn"),
            string::utf8(b"Corn"),
            string::utf8(b"CORN"),
            string::utf8(b"https://raw.githubusercontent.com/endless-labs/endless-core/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Corn.png"),
            string::utf8(b"https://www.endlesslabs.com"),
            5,
        );
        create_food_token_as_fungible_token(
            sender,
            ...
            string::utf8(b"https://raw.githubusercontent.com/endless-labs/endless-core/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Meat"),
            string::utf8(b"Meat"),
            string::utf8(b"MEAT"),
            string::utf8(b"https://raw.githubusercontent.com/endless-labs/endless-core/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Meat.png"),
            string::utf8(b"https://www.endlesslabs.com"),
            20,
        );
    }
    ...
    public fun food_balance(owner_addr: address, food: Object<FoodToken>): u128 {
    ...
    public entry fun mint_corn(creator: &signer, receiver: address, amount: u128) acquires FoodToken {
    ...
    public entry fun mint_meat(creator: &signer, receiver: address, amount: u128) acquires FoodToken {
    ...
    public entry fun transfer_corn(from: &signer, to: address, amount: u128) {
    ...
    public entry fun transfer_meat(from: &signer, to: address, amount: u128) {
        transfer_food(from, object::address_to_object<FoodToken>(meat_token_address()), to, amount);
    }

    public entry fun transfer_food(from: &signer, food: Object<FoodToken>, to: address, amount: u128) {
        let metadata = object::convert<FoodToken, Metadata>(food);
        primary_fungible_store::transfer(from, metadata, to, amount);
    }

    public(friend) fun burn_food(from: &signer, food: Object<FoodToken>, amount: u128) acquires FoodToken {
        let metadata = object::convert<FoodToken, Metadata>(food);
    ...
    fun mint_internal(creator: &signer, token: Object<FoodToken>, receiver: address, amount: u128) acquires FoodToken {
