...
module knight::knight {
    ...
    public entry fun feed_corn(from: &signer, to: Object<KnightToken>, amount: u128) acquires HealthPoint, KnightToken {
        let corn_token = object::address_to_object<FoodToken>(food::corn_token_address());
        feed_food(from, corn_token, to, amount);
    }

    public entry fun feed_meat(from: &signer, to: Object<KnightToken>, amount: u128) acquires HealthPoint, KnightToken {
    ...
    public entry fun feed_food(
        ...
        let restoration_amount = food::restoration_value(food) * (amount as u64);
