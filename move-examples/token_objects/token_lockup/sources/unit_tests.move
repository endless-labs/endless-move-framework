...
module token_lockup::unit_tests {
   ...
   #[test(creator = @0xFA, owner_1 = @0xA, owner_2 = @0xB, endless_framework = @0x1)]
   ...
   fun test_happy_path(
      ...
      setup_test(creator, owner_1, owner_2, endless_framework, TEST_START_TIME);
