...
module rewards_pool::rewards_pool {
    use endless_framework::fungible_asset::{Self, FungibleAsset, FungibleStore, Metadata};
    use endless_framework::primary_fungible_store;
    use endless_framework::object::{Self, Object, ExtendRef};
    use endless_std::pool_u64_unbound::{Self as pool_u64, Pool};
