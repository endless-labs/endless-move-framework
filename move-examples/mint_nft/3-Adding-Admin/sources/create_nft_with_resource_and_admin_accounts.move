...
/// - 1.a run `endless init --profile admin` to create an admin account
...
/// Run the following command in directory `endless-core/endless-move/move-examples/mint_nft/3-Adding-Admin`.
...
/// example output:
    /*
    3-Adding-Admin % endless move create-resource-account-and-publish-package --seed 1239 --address-name mint_nft --profile default --named-addresses source_addr=a911e7374107ad434bbc5369289cf5855c3b1a2938a6bfce0776c1d296271cde
    ...
    Do you want to submit a transaction for a range of [1567300 - 2350900] Veins at a gas unit price of 100 Veins? [yes/no] >
    yes
    {
      "Result": "Success"
    }
...
/// endless move run --function-id [resource account's address]::create_nft_with_resource_and_admin_accounts::mint_event_ticket --profile nft-receiver
/// example output:
    /*
    3-Adding-Admin % endless move run --function-id 34f5acaaef16988aa31bb56ad7b35e30d14ff9fc849d370be799617b61d3df04::create_nft_with_resource_and_admin_accounts::mint_event_ticket --profile nft-receiver
    {
...
/// endless move run --function-id [resource account's address]::create_nft_with_resource_and_admin_accounts::set_minting_enabled --args bool:true --profile admin
/// example output:
    /*
    3-Adding-Admin % endless move run --function-id 34f5acaaef16988aa31bb56ad7b35e30d14ff9fc849d370be799617b61d3df04::create_nft_with_resource_and_admin_accounts::set_minting_enabled --args bool:true --profile admin
    Do you want to submit a transaction for a range of [23100 - 34600] Veins at a gas unit price of 100 Veins? [yes/no] >
    yes
    {
      "Result": {
...
/// example output:
    /*
    3-Adding-Admin % endless move run --function-id 34f5acaaef16988aa31bb56ad7b35e30d14ff9fc849d370be799617b61d3df04::create_nft_with_resource_and_admin_accounts::mint_event_ticket --profile nft-receiver
    Do you want to submit a transaction for a range of [504500 - 756700] Veins at a gas unit price of 100 Veins? [yes/no] >
    yes
    {
      "Result": {
    ...
    */
/// - 4.d Check out the transactions on https://explorer.endlesslabs.com/ by searching for the transaction hash.
module mint_nft::create_nft_with_resource_and_admin_accounts {
    ...
    use endless_token::token::TokenDataId;
    ...
    /// See https://endless.dev/concepts/accounts/#resource-accounts for more details.
