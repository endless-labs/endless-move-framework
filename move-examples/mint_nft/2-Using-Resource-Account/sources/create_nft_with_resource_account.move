...
/// endless init --profile nft-receiver
///
/// 2. Publish the module under a resource account.
/// - 2.a Make sure you're in the right directory.
/// Run the following command in directory `endless-core/endless-move/move-examples/mint_nft/2-Using-Resource-Account`
...
/// example output:
    /*
    2-Using-Resource-Account % endless move create-resource-account-and-publish-package --seed 1235 --address-name mint_nft --profile default --named-addresses source_addr=a911e7374107ad434bbc5369289cf5855c3b1a2938a6bfce0776c1d296271cde
    ...
    Do you want to submit a transaction for a range of [1371100 - 2056600] Veins at a gas unit price of 100 Veins? [yes/no] >
    yes
    {
      "Result": "Success"
    }
...
/// endless move run --function-id [resource account's address]::create_nft_with_resource_account::mint_event_ticket --profile nft-receiver
///
/// example output:
    /*
    2-Using-Resource-Account % endless move run --function-id 55328567ff8aa7d242951af7fc1872746fbeeb89dfed0e1ee2ff71b9bf4469d6::create_nft_with_resource_account::mint_event_ticket --profile nft-receiver
    Do you want to submit a transaction for a range of [502900 - 754300] Veins at a gas unit price of 100 Veins? [yes/no] >
    yes
    {
      "Result": {
    ...
    */
/// - 4.b Check out the transaction on https://explorer.endlesslabs.com/ by searching for the transaction hash.
module mint_nft::create_nft_with_resource_account {
    ...
    /// See https://endless.dev/concepts/accounts/#resource-accounts for more information about resource account.
