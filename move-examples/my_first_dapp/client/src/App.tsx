import { WalletSelector } from "@endless-labs/wallet-adapter-ant-design";
import { Layout, Row, Col, Button, Spin, List, Checkbox, Input } from "antd";

import React, { useEffect, useState } from "react";
import { useWallet, InputTransactionData } from "@endless-labs/wallet-adapter-react";

import "@endless-labs/wallet-adapter-ant-design/dist/index.css";
import { CheckboxChangeEvent } from "antd/es/checkbox";
import { Endless } from "@endless-labs/ts-sdk";
...
export const endless = new Endless();
...
function App() {
  ...
  const fetchList = async () => {
    if (!account) return [];
    try {
      const todoListResource = await endless.getAccountResource(
      ...
      while (counter <= taskCounter) {
        ...
        const task = await endless.getTableItem<Task>({handle:tableHandle, data:tableItem});
        tasks.push(task);
        counter++;
      }
                  ...
                  renderItem={(task: Task) => (
                    ...
                    >
                      <List.Item.Meta
                        ...
                        description={
                          <a
                            href={`https://explorer.endlesslabs.com/account/${task.address}/`}
                            target="_blank"
