This package provides an experimental service for uploading very large modules to the Endless network. To publish using this API, you must divide your metadata and modules across multiple calls into `large_packages::stage_code`. Specifically:
...
The above logic is currently implemented in the Python SDK: `endless-core/ecosystem/python/sdk/endless_sdk/package_publisher.py`
