...
/// 1. [Devnet](https://fullnode.devnet.endlesslabs.com/v1/spec#/) -- a shared resource for the community, data resets weekly, weekly update from endless-core main branch.
/// 1. [Testnet](https://fullnode.testnet.endlesslabs.com/v1/spec#/) -- a shared resource for the community, data will be preserved, network configuration will mimic Mainnet.
/// 1. [Mainnet](https://fullnode.mainnet.endlesslabs.com/v1/spec#/) -- a production network with real assets.
///
/// See [Endless Blockchain Networks](../nodes/networks.md) for full details on each environment.
///
/// ### Run a local testnet
///
/// There are two options for running a local testnet:
/// * Directly [run a local testnet](../nodes/local-testnet/run-a-local-testnet.md) using either the [Endless-core source code](../nodes/local-testnet/run-a-local-testnet.md#using-the-endless-core-source-code) or a [Docker image](../nodes/local-testnet/run-a-local-testnet.md#using-docker). These paths are useful for testing changes to the Endless-core codebase or framework, or for building services on top of the Endless blockchain, respectively.
/// * [Install the Endless CLI](../tools/install-cli/index.md) and 2) start a [local node with a faucet](../nodes/local-testnet/using-cli-to-run-a-local-testnet.md#starting-a-local-testnet-with-a-faucet). This path is useful for developing on the Endless blockchain, debugging Move contracts, and testing node operations.
///
/// Either of these methods will expose a [REST API service](../integration/fullnode-rest-api.md) at `http://127.0.0.1:8080` and a Faucet API service at `http://127.0.0.1:8000` for option 1 run a local testnet or `http://127.0.0.1:8081` for option 2 install the Endless CLI. The applications will output the location of the services.
///
...
///     <ul>
///       <li>REST API: <a href="https://fullnode.devnet.endlesslabs.com/v1">https://fullnode.devnet.endlesslabs.com/v1</a></li>
///       <li>REST API Spec: <a href="https://fullnode.devnet.endlesslabs.com/v1/spec#/">https://fullnode.devnet.endlesslabs.com/v1/spec#/</a></li>
///       <li>Indexer API: <a href="https://indexer-devnet.staging.gcp.endlessdev.com/v1/graphql">https://indexer-devnet.staging.gcp.endlessdev.com/v1/graphql</a></li>
///       <li>Faucet API: <a href="https://faucet.devnet.endlesslabs.com">https://faucet.devnet.endlesslabs.com</a></li>
///       <li><a href="https://cloud.hasura.io/public/graphiql?endpoint=https://indexer-devnet.staging.gcp.endlessdev.com/v1/graphql">Indexer GraphQL</a></li>
///     </ul>
///   </TabItem>
///   <TabItem value="testnet" label="Testnet">
///     <ul>
///       <li>REST API: <a href="https://fullnode.testnet.endlesslabs.com/v1">https://fullnode.testnet.endlesslabs.com/v1</a></li>
///       <li>REST API Spec: <a href="https://fullnode.testnet.endlesslabs.com/v1/spec#/">https://fullnode.testnet.endlesslabs.com/v1/spec#/</a></li>
///       <li>Indexer API: <a href="https://indexer-testnet.staging.gcp.endlessdev.com/v1/graphql">https://indexer-testnet.staging.gcp.endlessdev.com/v1/graphql</a></li>
///       <li>Faucet API: <a href="https://faucet.testnet.endlesslabs.com">https://faucet.testnet.endlesslabs.com</a></li>
///       <li><a href="https://cloud.hasura.io/public/graphiql?endpoint=https://indexer-testnet.staging.gcp.endlessdev.com/v1/graphql">Indexer GraphQL</a></li>
///     </ul>
///   </TabItem>
///   <TabItem value="mainnet" label="Mainnet">
///     <ul>
///       <li>REST API: <a href="https://fullnode.mainnet.endlesslabs.com/v1">https://fullnode.mainnet.endlesslabs.com/v1</a></li>
///       <li>REST API Spec: <a href="https://fullnode.mainnet.endlesslabs.com/v1/spec#/">https://fullnode.mainnet.endlesslabs.com/v1/spec#/</a></li>
///       <li>Indexer API: <a href="https://indexer.mainnet.endlesslabs.com/v1/graphql">https://indexer.mainnet.endlesslabs.com/v1/graphql</a></li>
///       <li>Faucet: N/A</li>
///       <li><a href="https://cloud.hasura.io/public/graphiql?endpoint=https://indexer.mainnet.endlesslabs.com/v1/graphql">Indexer GraphQL</a></li>
///     </ul>
///   </TabItem>
/// </Tabs>
///
...
///
/// Almost all developers will benefit from exploring the CLI. [Using the CLI](../tools/endless-cli-tool/use-endless-cli.md) demonstrates how the CLI can be used to which includes creating accounts, transferring coins, and publishing modules.
///
/// ## Accounts on Endless
///
///
/// At creation, an [Endless account](https://github.com/endless-labs/endless-core/blob/88c9aab3982c246f8aa75eb2caf8c8ab1dcab491/endless-move/framework/endless-framework/sources/account.move#L23) contains:
/// * A [resource containing Endless Coin](https://github.com/endless-labs/endless-core/blob/60751b5ed44984178c7163933da3d1b18ad80388/endless-move/framework/endless-framework/sources/coin.move#L50) and deposit and withdrawal of coins from that resource.
...
///
/// Read more about [Accounts](../concepts/accounts.md) and [set one up](../tools/endless-cli-tool/use-endless-cli#initialize-local-configuration-and-create-an-account).
///
/// ## Transactions
///
///
...
/// - A script (payload)
///
/// Both [Python](https://github.com/endless-labs/endless-core/blob/3973311dac6bb9348bfc81cf983c2a1be11f1b48/ecosystem/python/sdk/endless_sdk/client.py#L256) and [TypeScript](https://github.com/endless-labs/endless-core/blob/3973311dac6bb9348bfc81cf983c2a1be11f1b48/ecosystem/typescript/sdk/src/endless_client.test.ts#L93) support the generation of transactions that target entry points. This guide points out many of those entry points, such as `endless_account::transfer` and `endless_account::create_account`.
///
/// Most basic operations on the Endless blockchain should be available via entry point calls. While one could submit multiple transactions calling entry points in series, such operations benefit from being called atomically from a single transaction. A script payload transaction can call any public (entry) function defined within any module. Here's an example [Move script](https://github.com/endless-labs/endless-core/tree/main/endless-move/move-examples/scripts/two_by_two_transfer) that uses a MultiAgent transaction to extract funds from two accounts and deposit them into two other accounts. This is a [Python example](https://github.com/endless-labs/endless-core/blob/main/ecosystem/python/sdk/examples/transfer-two-by-two.py) that uses the bytecode generated by compiling that script. Currently there is limited support for script payloads in TypeScript.
///
...
///
///
/// Both the [Typescript SDK](https://github.com/endless-labs/endless-core/blob/9b85d41ed8ef4a61a9cd64f9de511654fcc02024/ecosystem/typescript/sdk/src/endless_client.ts#L413) and [Python SDK](https://github.com/endless-labs/endless-core/blob/main/ecosystem/python/sdk/examples/simulate-transfer-coin.py) support the simulation API. Note the output and gas used may change based upon the state of the account. For gas estimations, we recommend that the maximum gas amount be larger than the amount quoted by this API.
///
...
///
/// Events and transactions pruning can be disabled via setting the [`enable_ledger_pruner`](https://github.com/endless-labs/endless-core/blob/cf0bc2e4031a843cdc0c04e70b3f7cd92666afcf/config/src/config/storage_config.rs#L141) to `false`. This is default behavior in Mainnet. In the near future, Endless will provide indexers that mitigate the need to directly query from a node.
///
/// The REST API offers querying transactions and events in these ways:
///
/// * [Transactions for an account](https://fullnode.devnet.endlesslabs.com/v1/spec#/operations/get_account_transactions)
/// * [Transactions by version](https://fullnode.devnet.endlesslabs.com/v1/spec#/operations/get_transaction_by_version)
/// * [Events by event handle](https://fullnode.devnet.endlesslabs.com/v1/spec#/operations/get_events_by_event_handle)
///
/// ## Exchanging and tracking coins
///
/// Endless has a standard [Coin type](https://github.com/endless-labs/endless-core/blob/main/endless-move/framework/endless-framework/sources/coin.move). Different types of coins can be represented in this type through the use of distinct structs that represent the type parameter or generic for `Coin<T>`.
///
...
///
/// Coins can be transferred between users via the [`coin::transfer`](https://github.com/endless-labs/endless-core/blob/36a7c00b29a457469264187d8e44070b2d5391fe/endless-move/framework/endless-framework/sources/coin.move#L307) function for all coins and [`endless_account::transfer`](https://github.com/endless-labs/endless-core/blob/88c9aab3982c246f8aa75eb2caf8c8ab1dcab491/endless-move/framework/endless-framework/sources/endless_account.move#L18) for Endless coins. The advantage of the latter function is that it creates the destination account if it does not exist.
///
/// :::caution
...
///
/// This tutorial is for SDK and wallet developers who want to integrate with the [Endless Faucet](https://github.com/endless-labs/endless-core/tree/main/crates/endless-faucet). If you are a dapp developer, you should access the faucet through an existing [SDK](../tutorials/first-transaction.md) or [CLI](../tools/endless-cli-tool/use-endless-cli#initialize-local-configuration-and-create-an-account) instead.
///
...
/// If you are building a client in JavaScript or TypeScript, you should make use of the [@endless-labs/endless-faucet-client](https://www.npmjs.com/package/@endless-labs/endless-faucet-client) package. This client is generated based on the OpenAPI spec published by the faucet service.
///
/// Example use:
/// ```typescript
/// import {
...
///   const faucetClient = new EndlessFaucetClient({BASE: "https://faucet.devnet.endlesslabs.com"});
...
/// 1. Generate a client from the [OpenAPI spec](https://github.com/endless-labs/endless-core/blob/main/crates/endless-faucet/doc/spec.yaml).
...
/// ```
///
/// This means mint 10000 VEINS to address `0xd0f523c9e73e6f3d68c16ae883a9febc616e484c4998a72d8899a1009e5a89d6`.
